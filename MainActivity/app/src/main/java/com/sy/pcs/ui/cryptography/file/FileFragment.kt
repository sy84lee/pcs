package com.sy.pcs.ui.cryptography.file
...
import com.sy.pcs.databinding.FragmentFileEncryptBinding
import java.io.File
...
class FileFragment : Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 111 && resultCode == RESULT_OK) {
            ...
            //binding.textInputLayoutSelectedFile.setText(selectedFile.absoluteFile.toString())
            val uri = data?.data
            if (uri != null) {
