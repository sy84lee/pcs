package com.sy.pcs.ui.cryptography.text
...
import com.sy.pcs.R
import com.sy.pcs.databinding.FragmentTextBinding
import com.sy.pcs.ui.cryptography.text.aes.TextEncryptFragment
...
class TextFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        buttonAES!!.setOnClickListener(View.OnClickListener {
            //parentFragmentManager.beginTransaction().remove(TextFragment()).commit()
            parentFragmentManager.beginTransaction().replace(R.id.nav_host_fragment_activity_main, TextEncryptFragment()).addToBackStack(null).commit()
            //parentFragmentManager.beginTransaction().replace(R.id.tabLayoutTL, AesFragment()).addToBackStack(null).commit()
        })
